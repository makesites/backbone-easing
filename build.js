...
concat({
	src : [
		...
		'bower_components/tick/tick.js'
	],
	dest : 'build/backbone.easing.js'
});


// - Validate js
lint('build/backbone.easing.js', function(){

	// - Create / save minified file
	uglify('build/backbone.easing.js', 'build/backbone.easing-min.js');
